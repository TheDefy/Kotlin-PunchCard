...
public class PackageUtils {
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        Logger.d(new StringBuilder().append("installSilent successMsg:").append(commandResult.successMsg)
    ...
    public static int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        Logger.d(new StringBuilder().append("uninstallSilent successMsg:").append(commandResult.successMsg)
                .append(", ErrorMsg:").append(commandResult.errorMsg).toString());
        if (commandResult.errorMsg == null) {
     ...
     * @return
     */
    public static PackageInfo getAPKFilePackageInfo(Context context, String path) {
        PackageInfo packageInfo;
     ...
     * @param packageName
     */
    public static void startTargetPackage(Context context, String packageName) {
        if (!PackageUtils.isTopActivity(context, packageName)) {
            Logger.d("the file was installed,and it is not running,I will start it!");
            try {
           ...
           Logger.d("the file was installed,and it is running!");
        }
    }

    public static void startTargetPackageWithShell(Context context, String packageName) {
        if (!PackageUtils.isTopActivity(context, packageName)) {
            ShellUtils.execCommand("monkey -p " + packageName + " --pct-syskeys 0 -c android.intent.category.LAUNCHER 1", true);
        }
    }

package com.bbtree.cardreader.view.banner;
...
//        drawable.setIntrinsicWidth(interval);
    ...
    private void calculateLayoutParams() {
        Bitmap bitmap = null;
        try {
            bitmap = BitmapFactory.decodeResource(mContext.getResources(), mIndicatorSelectRes);
            layoutParams = new LinearLayout.LayoutParams(bitmap.getWidth() / 2, bitmap.getWidth() / 2);
